...
public class LoginAsyncTask extends AsyncTask<Administrador, Void, Response> {
    ...
    protected void onPostExecute(Response response) {
        ...
        if (codeHttp != HttpURLConnection.HTTP_OK) {
            ...
            List<Administrador> ListaAdministrador = gson.fromJson(response.getContentValue(),
                    new TypeToken<ArrayList<Administrador>>(){}.getType());

            Administrador administrador = ListaAdministrador.get(0);
