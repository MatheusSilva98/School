...
public class PessoasCustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.activity_listar_pessoa, null);
        ...
        holder.txtId.setText("Identificação única "+pessoaItem.getId());

        if (pessoaItem.isEntregue()){

            holder.txtIsDelivered.setText("Situação: Entregue");

        }else{

            holder.txtIsDelivered.setText("Situação: Não entregue");
